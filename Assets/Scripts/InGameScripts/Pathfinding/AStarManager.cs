...
public class AStarManager : MonoBehaviour
{
    ...
    public List<Node> GeneratePath(Node start, Node end) // pokoknya buat algoritma A*nya, ntar dari 2 node/jalan dipilih yang paling singkat, sisanya gak tau juga aku bingung cik
    {
